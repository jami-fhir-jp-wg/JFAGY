...
# 入力ファイルはエクセル公開ファイルをエクセルの機能でCSV(UTF-8)保存したもの。
...
# 例：cd GitHub/JFAGY/; python3 python/generateAllergyCSVfile.py masterResources/JFAGY_20250401V2.csv  ./download_files/JFAGY_J9FN_20250401_R01  
